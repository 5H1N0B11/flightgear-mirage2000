...
#For the mirage 2000 only : A way to temporary desactivate doppler fonction
...
var Radar = {
   ...
   next_Target_Index: func(){
    ...
    setDetectiontype: func(type){
      #Can be change in flight, for ground detection. can be "radar" or "laser"
      if(type =="radar" or type == "laser"){
        me.detectionTypetab = type;
      }
    },
    #toggle_Type: func(){
