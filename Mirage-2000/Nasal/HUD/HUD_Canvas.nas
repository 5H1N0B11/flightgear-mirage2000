...
var HUD = {
    ...
    new: func(placement) {
        ...
        # Airspeed
        m.airspeed = m.text.createChild("text")
                .setAlignment("right-center")
                .setTranslation(-180, 0);

        # Groundspeed
        m.groundspeed = m.text.createChild("text")
                .setAlignment("left-center")
                .setTranslation(-220, 90);

        # Vertical speed
        m.vertical_speed = m.text.createChild("text")
                .setFontSize(10, 0.9)
                .setAlignment("right-center")
                .setTranslation(205, 50);

        # Radar altidude
        m.rad_alt = m.text.createChild("text")
                .setAlignment("right-center")
        ...
        m.energy_cue = m.fpv.createChild("path")
            .setStrokeLineWidth(1);

        m.acc = m.fpv.createChild("path")
            .setStrokeLineWidth(1);
    ...
    update: func()
    {
        ...
        if( rad_alt and rad_alt < 5000 )
        {
            # Only show below 5000AGL
        ...
        {
            speed_error = 4 * clamp(me.input.target_spd.getValue() - me.input.airspeed.getValue(), -15, 15);
        }
