...
var processCallsigns = func() {
    ...
    foreach(var player ; players)
    {
        if(player.getChild("valid") != nil
            ...
            and player.getChild("callsign") != nil
            and player.getChild("callsign").getValue() != ""
            and player.getChild("callsign").getValue() != nil)
        {
...
var ct = func(type) {
    ...
    elsif(type == "rl" and getprop("gear/gear[0]/wow") != TRUE)
    {
        setprop("sim/ct/rl", 1);
    }
    elsif(type == "rp" and getprop("gear/gear[0]/wow") != TRUE)
    {
        setprop("sim/ct/rp", 1);
    }
    elsif(type == "a")
    ...
    elsif(type == "ifa" and getprop("gear/gear[0]/wow") != TRUE)
    {
        setprop("sim/ct/ifa", 1);
    }
    elsif(type == "sf" and getprop("gear/gear[0]/wow") != TRUE)
    {
        setprop("sim/ct/sf", 1);
    }
}
