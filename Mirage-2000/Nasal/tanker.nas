print("*** LOADING tanker.nas ... ***");
################################################################################
#
#                       m2005-5's TANKER SETTINGS
#
################################################################################
    ...
    update: func()
    {
        ...
        else
        {
            ...
            if((me.turn_remaining -= deviation) < 0)
            {
                if(me.goal[1] == nil)
                {
                    # define tanker exit point (opposite of anchor point/ARCP)
        ...
        me.contactN.setBoolValue(me.distance < ac_contact_dist
            and dalt > 0
...
var create_tanker = func(tanker_node, course)
{
    ...
    if(getprop("/sim/aircraft") == "m2000-5")
    {
        alt = 22000;
    }
