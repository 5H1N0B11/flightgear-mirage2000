...
var computeSAS = func() {
    ...
    else
    {
        ...
        if(airspeed >280)
        {
            ...
            {
                # Tab G pos
                if(last_e < 0.1 and gload > 0 and (abs(last_e)>0.4 or abs(p_input)==1 or  gload > maxG*0.2) and abs(last_e_tab[0]-last_e_tab[1])>0 and airspeed>10 and myBrakes==0 and wow==0)
                {
                    shiftTab(Gpos, gload);
                }
            ...
            else
            {
                #print("Descent:");
                # Tab Gneg
                if(last_e > 0.1 and gload < 0 and (abs(last_e)>0.4 or abs(p_input)==1 or  gload < minG*0.2) and abs(last_e_tab[0]-last_e_tab[1])>0 and airspeed>10 and myBrakes==0 and wow==0)
                {
                    shiftTab(Gneg, gload);
                }
        ...
        if(airspeed < 320)
        {
            ...
            if(raw_e < 0)
            {
                ...
                # Tab aoa pos
                if(last_e < 0.1 and alpha > 0 and (abs(last_e)>0.9 or abs(p_input)==1 or  alpha > maxAoa*0.5) and abs(last_e_tab[0]-last_e_tab[1])>0 and airspeed>10 and myBrakes==0 and wow==0)
                {
            ...
            else
            {
                #print("Descent:");
                # Tab aoaneg
                if(last_e > 0.1 and alpha < 0 and (abs(last_e)>0.9 or abs(p_input)==1 or  alpha < minAoa*0.5) and abs(last_e_tab[0]-last_e_tab[1])>0 and airspeed>10 and myBrakes==0 and wow==0)
                {
        ...
        #p_input = abs(p_input)<0.001?0:p_input;
        if(abs(p_input)<0.001 and abs(raw_e)>0.99){
          init_matrix();
        ...
        if(AutoTrim.getValue()){
          if(abs(raw_e)<0.01 and wow==0 and abs(OrientationPitch.getValue())<45 and abs(OrientationRoll.getValue())<45 and myBrakes==0){
          ...
          if(abs(raw_e)>0.9 and airspeed>220){
           if(abs(e_trim)>0.01){
        ...
        if(alpha>10 and myMach<0.26){myMaxRoll=myMaxRoll/2;}
       ...
       # Average : only for the latency
        ...
        if(AutoTrim.getValue() ){
          ...
          if(abs(raw_a)>0.5){AileronTrim.setValue(0);}
        }
